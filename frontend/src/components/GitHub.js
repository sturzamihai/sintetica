				...
				<div className="section-body">
					<div className="row text-center align-items-center">
						<div className="col-lg-7 text-left">
							...
							<p>
								De la pagina de prezentare pană la implementarea algorimilor și
								servirea lor printr-un API.{" "}
							</p>
							<a
						...
						<div className="col-lg-5">
							<FontAwesomeIcon
								...
								className="git-icons"
							/>
							<FontAwesomeIcon icon={faPlus} size="3x" className="git-icons" />
							<FontAwesomeIcon icon={faCode} size="3x" className="git-icons" />
							<FontAwesomeIcon
								icon={faEquals}
								size="3x"
								className="git-icons"
